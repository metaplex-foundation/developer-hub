...
const standaloneRedirects = {
  ...
  '/ja/dev-tools/skill': '/ja/agents/skill',
  '/ja/dev-tools/skill/installation': '/ja/agents/skill/installation',
  '/ja/dev-tools/skill/how-it-works': '/ja/agents/skill/how-it-works',
  '/ja/dev-tools/skill/programs-and-operations': '/ja/agents/skill/programs-and-operations',
  '/ko/dev-tools/skill': '/ko/agents/skill',
  '/ko/dev-tools/skill/installation': '/ko/agents/skill/installation',
  '/ko/dev-tools/skill/how-it-works': '/ko/agents/skill/how-it-works',
  '/ko/dev-tools/skill/programs-and-operations': '/ko/agents/skill/programs-and-operations',
  '/zh/dev-tools/skill': '/zh/agents/skill',
  '/zh/dev-tools/skill/installation': '/zh/agents/skill/installation',
  '/zh/dev-tools/skill/how-it-works': '/zh/agents/skill/how-it-works',
  '/zh/dev-tools/skill/programs-and-operations': '/zh/agents/skill/programs-and-operations',
  // mint-agent and register-agent consolidated into create-agent
  '/agents/mint-agent': '/agents/create-agent',
  '/agents/register-agent': '/agents/create-agent',
  '/ja/agents/mint-agent': '/ja/agents/create-agent',
  '/ja/agents/register-agent': '/ja/agents/create-agent',
  '/ko/agents/mint-agent': '/ko/agents/create-agent',
  '/ko/agents/register-agent': '/ko/agents/create-agent',
  '/zh/agents/mint-agent': '/zh/agents/create-agent',
  '/zh/agents/register-agent': '/zh/agents/create-agent',
