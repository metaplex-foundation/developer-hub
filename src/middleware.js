...
const standaloneRedirects = {
  ...
  // Agents: Nori service-agent prototype replaced by the shipped Metaplex x402 service.
  // The name "Nori" now refers to the Metaplex AI copilot, a separate product.
  '/agents/nori': '/agents/x402',
  '/agents/nori/delegate-to-nori': '/agents/x402/payment-modes',
  '/agents/nori/pricing-and-billing': '/agents/x402/api-reference',
  '/agents/nori/example-agents': '/agents/x402/payment-modes',
  '/ja/agents/nori': '/ja/agents/x402',
  '/ja/agents/nori/delegate-to-nori': '/ja/agents/x402/payment-modes',
  '/ja/agents/nori/pricing-and-billing': '/ja/agents/x402/api-reference',
  '/ja/agents/nori/example-agents': '/ja/agents/x402/payment-modes',
  '/ko/agents/nori': '/ko/agents/x402',
  '/ko/agents/nori/delegate-to-nori': '/ko/agents/x402/payment-modes',
  '/ko/agents/nori/pricing-and-billing': '/ko/agents/x402/api-reference',
  '/ko/agents/nori/example-agents': '/ko/agents/x402/payment-modes',
  '/zh/agents/nori': '/zh/agents/x402',
  '/zh/agents/nori/delegate-to-nori': '/zh/agents/x402/payment-modes',
  '/zh/agents/nori/pricing-and-billing': '/zh/agents/x402/api-reference',
  '/zh/agents/nori/example-agents': '/zh/agents/x402/payment-modes',
