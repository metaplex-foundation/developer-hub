...
const AI_SERVICES = [
  ...
  {
    name: 'Perplexity',
    href: (prompt) => `https://www.perplexity.ai/search?q=${encodeURIComponent(prompt)}`,
    icon: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" fillRule="evenodd" aria-hidden="true">
          ...
          <div className="py-1" role="menu">
            {AI_SERVICES.map((service) => (
              <a
                ...
                role="menuitem"
                className="flex items-center gap-2.5 px-3 py-2 text-xs text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
