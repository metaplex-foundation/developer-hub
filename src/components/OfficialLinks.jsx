...
const programs = [
  ...
  { name: 'MPL Agent Identity', programId: '1DREGFgysWYxLnRnKQnwrxnJQeSMk2HmGaC6whw2B2p', github: 'https://github.com/metaplex-foundation/mpl-agent', docs: '/smart-contracts/mpl-agent/identity' },
  { name: 'MPL Agent Tools', programId: 'TLREGni9ZEyGC3vnPZtqUh95xQ8oPqJSvNjvB7FGK8S', github: 'https://github.com/metaplex-foundation/mpl-agent', docs: '/smart-contracts/mpl-agent/tools' },
