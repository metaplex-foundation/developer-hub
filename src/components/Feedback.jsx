    ...
    <>
      <div className="not-prose my-12 grid grid-cols-1 gap-6 sm:grid-cols-1">
        <div className="group relative rounded-xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="relative overflow-hidden rounded-xl p-6">
            <h2 className="font-display text-base text-slate-900 dark:text-white">
              <span className="-inset-px rounded-xl"></span>Thanks for
              your feedback. We will try to improve :( <br />
            </h2>
            <a href='https://metaplex.canny.io/developers?selectedCategory=documentation#introduction'>Do you want to give additional feedback?</a>
          </div>
        </div>
      </div>
    </>
          ...
          <div>
            <Widget
              ...
              classes={{
                ...
                reaction:
                  'relative overflow-hidden rounded-xl p-6 font-semibold w-full',
              }}
            />
          </div>
        ) : reaction === 'No' ? (
