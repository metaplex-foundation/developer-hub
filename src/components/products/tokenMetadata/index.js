      ...
      navigation: [
        {
          ...
          links: [
            ...
            {
              title: 'Create a claim based airdrop using MPL-Distro',
  ...
  localizedNavigation: {
    en: {
      ...
      links: {
        ...
        'Create a claim based airdrop using MPL-Distro': 'Create a claim based airdrop using MPL-Distro',
    ...
    ja: {
      ...
      links: {
        ...
        'Create a claim based airdrop using MPL-Distro': 'MPL-Distroを使用したクレームベースのエアドロップを作成',
    ...
    ko: {
      ...
      links: {
        ...
        'Create a claim based airdrop using MPL-Distro': 'MPL-Distro를 사용한 클레임 기반 에어드롭 생성',
    ...
    zh: {
      ...
      links: {
        ...
        'Create a claim based airdrop using MPL-Distro': '使用 MPL-Distro 创建基于领取的空投',
