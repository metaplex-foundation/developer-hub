...
export const agentMenuCategory = [
  ...
  {
    name: 'Agent Finance',
    headline: 'Capitalize and govern your AI agent through its own onchain token.',
    description: 'Capitalize and govern your AI agent through its own onchain token.',
    navigationMenuCatergory: 'Agents',
    href: '/agents/agent-finance',
    localizedNavigation: {
      ja: { name: 'エージェントファイナンス', headline: 'AIエージェントを独自のオンチェーントークンで資金調達・ガバナンスします。' },
      ko: { name: '에이전트 파이낸스', headline: '자체 온체인 토큰으로 AI 에이전트의 자본을 조달하고 거버넌스합니다.' },
      zh: { name: 'Agent 金融', headline: '通过 AI Agent 自身的链上代币进行资本化与治理。' },
    },
  },
  {
    name: 'Agent Commerce',
    headline: 'How AI agents earn revenue, pay for services, and transact onchain.',
    description: 'How AI agents earn revenue, pay for services, and transact onchain.',
    navigationMenuCatergory: 'Agents',
    href: '/agents/agent-commerce',
    localizedNavigation: {
      ja: { name: 'エージェントコマース', headline: 'AIエージェントが収益を得て、サービスに支払い、オンチェーンで取引する方法。' },
      ko: { name: '에이전트 커머스', headline: 'AI 에이전트가 수익을 얻고, 서비스에 비용을 지불하며, 온체인에서 거래하는 방법.' },
      zh: { name: 'Agent 商业', headline: 'AI Agent 如何赚取收入、支付服务费用并在链上进行交易。' },
    },
  },
  {
