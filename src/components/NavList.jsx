...
export const agentMenuCategory = [
  ...
  },
  {
    ...
    headline: 'How agent identity, wallets, and delegation work.',
    description: 'Autonomous agents on Solana are MPL Core assets with built-in wallets and on-chain identity records.',
    navigationMenuCatergory: 'Agents',
    href: '/agents/what-is-an-agent',
    localizedNavigation: {
      ja: { name: 'エージェントとは？', headline: 'エージェントのID、ウォレット、委任の仕組み。' },
      ko: { name: '에이전트란?', headline: '에이전트 ID, 지갑, 위임의 작동 방식.' },
      zh: { name: '什么是代理？', headline: '代理身份、钱包和委托的工作原理。' },
    },
  },
  {
    name: 'Create an Agent',
    headline: 'Mint and register an agent on Solana.',
    description: 'Create an MPL Core asset and register its identity — via the Metaplex API or the on-chain instruction.',
    navigationMenuCatergory: 'Agents',
    href: '/agents/create-agent',
    localizedNavigation: {
      ja: { name: 'エージェントを作成', headline: 'Solana上でエージェントをミントして登録します。' },
      ko: { name: '에이전트 생성', headline: 'Solana에서 에이전트를 민트하고 등록합니다.' },
      zh: { name: '创建代理', headline: '在Solana上铸造并注册代理。' },
    },
  },
  {
