...
export function CodeTabs({
  ...
  return (
    <CodeTabsContext.Provider value={{ activeLanguage, setActiveLanguage: (lang) => {
      ...
      <div className={clsx('code-tabs not-prose my-6 overflow-hidden rounded-lg border border-slate-200 dark:border-slate-800', className)}>
        {/* Tab buttons */}
        <div
          className="flex items-center gap-2 overflow-x-auto border-b border-slate-200 bg-slate-100 px-4 dark:border-slate-700 dark:bg-slate-800"
          role="tablist"
