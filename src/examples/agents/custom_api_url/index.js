 ...
 *
 * Target a staging or self-hosted Metaplex API by passing baseUrl in the config argument.
 *
...
export const metadata = {
  ...
  description: "Target a staging or self-hosted Metaplex API by passing baseUrl in the config argument.",
