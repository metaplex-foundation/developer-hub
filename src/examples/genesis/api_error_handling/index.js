 ...
 *
 * Handle validation, API, and network errors when creating a launch with the Genesis API client.
 *
...
export const metadata = {
  ...
  description: "Handle validation, API, and network errors when creating a launch with the Genesis API client.",
  tags: ['genesis', 'api-client', 'error-handling', 'beginner'],
}
