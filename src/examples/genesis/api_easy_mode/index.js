/**
 * Example: Easy Mode Launch
 *
 * Create and register a token launch in a single call using the Genesis API client.
 *
...
export const metadata = {
  title: "Easy Mode Launch",
  description: "Create and register a token launch in a single call using the Genesis API client.",
  tags: ['genesis', 'api-client', 'launch', 'beginner'],
}
