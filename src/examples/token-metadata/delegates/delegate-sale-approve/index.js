...
const umiSections = {
  "imports": "import { delegateSaleV1 } from '@metaplex-foundation/mpl-token-metadata';",
  "setup": "// Assuming umi, mint, owner, and saleDelegate are set up",
  "main": "await delegateSaleV1(umi, {\n  mint,\n  tokenOwner: owner.publicKey,\n  authority: owner,\n  delegate: saleDelegate,\n  tokenStandard: TokenStandard.ProgrammableNonFungible,\n}).sendAndConfirm(umi);",
  "output": "console.log('Sale delegate approved');",
