...
이는 프로그램이 [크로스 프로그램 호출](#cross-program-invocations-cpi)에 서명할 수 있게 하거나 결정적으로 파생될 수 있는 주소 내에서 어카운트 생성을 가능하게 하는 등 다양한 사용 사례가 있습니다.
...
### 크로스 프로그램 호출 (CPI) {% #cross-program-invocations-cpi %}
