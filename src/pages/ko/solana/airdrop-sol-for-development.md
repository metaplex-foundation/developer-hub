...
- [A keypair/wallet configured](/solana/solana-keypairs-and-wallets)
...
See the [local validator guide](/solana/setup-a-local-validator) for detailed setup.
...
- [Setup a local validator](/solana/setup-a-local-validator) - Unlimited SOL for testing
- [Solana CLI essentials](/solana/solana-cli-essentials) - Master the CLI
- [Working with devnet and testnet](/solana/working-with-devnet-and-testnet) - Network deep dive
