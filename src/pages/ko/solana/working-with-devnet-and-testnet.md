...
- [A keypair configured](/solana/solana-keypairs-and-wallets)
...
See [Airdrop SOL for Development](/solana/airdrop-sol-for-development) for more options.
...
See [Setup a Local Validator](/solana/setup-a-local-validator) for the basic setup guide.
...
- Wait and retry
- Use a [web faucet](/solana/airdrop-sol-for-development)
- Switch to localnet for unlimited SOL

## Next Steps

- [Amman documentation](/dev-tools/amman) - Full Amman setup and configuration
- [Setup a local validator](/solana/setup-a-local-validator) - Basic local validator guide
- [Getting SOL for development](/solana/airdrop-sol-for-development) - Devnet SOL sources
