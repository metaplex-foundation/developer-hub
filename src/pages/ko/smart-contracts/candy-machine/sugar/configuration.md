...
Candy Machine은 민팅에 대한 접근 제어를 제공하는 여러 가드를 지원합니다. [가드](/ko/smart-contracts/candy-machine/guards)는 "기본" [가드 그룹](/ko/smart-contracts/candy-machine/guard-groups)으로 구성되거나 여러 가드 그룹에 나타날 수 있습니다.