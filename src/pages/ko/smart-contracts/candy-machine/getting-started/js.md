...
그런 다음 사용할 지갑을 Umi에게 알려주어야 합니다. 이는 [키페어](/ko/dev-tools/umi/getting-started#connecting-w-a-secret-key) 또는 [Solana 지갑 어댑터](/ko/dev-tools/umi/getting-started#connecting-w-wallet-adapter)일 수 있습니다.
