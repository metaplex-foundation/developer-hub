...
[이전 페이지](/smart-contracts/auction-house/settings)에서 Auction House의 다양한 설정을 살펴보았습니다. 이제 이러한 설정을 사용하여 Auction House를 만들고 업데이트하는 방법을 살펴보겠습니다.
...
이 시점에서 우리는 Auction House 설정, Auction House 인스턴스가 저장하는 데이터 및 이 데이터를 만들고 업데이트하는 방법을 살펴보았습니다. 그러나 우리는 아직 Auction House에서 자산이 어떻게 거래되는지 모릅니다. [다음 페이지](/smart-contracts/auction-house/trading-assets)에서 이에 대해 이야기할 것입니다.
