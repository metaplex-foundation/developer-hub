...
| **런칭 타입** | 런칭 카테고리(`project` 또는 `memecoin`). 생성 후 백엔드 크랭크에 의해 온체인으로 소급 설정. [SDK](/smart-contracts/genesis/sdk/javascript#genesis-account) 또는 [REST API](/smart-contracts/genesis/integration-apis)로 조회 가능 |
