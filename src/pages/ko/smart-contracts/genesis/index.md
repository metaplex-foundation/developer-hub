...
description: Solana에서 가격 판매 런칭과 런치 풀을 통해 토큰을 런칭하기 위한 스마트 컨트랙트입니다.
---

Genesis는 Solana 블록체인에서 **토큰 생성 이벤트(TGE)**를 위한 유연한 프레임워크를 제공하는 Metaplex 스마트 컨트랙트입니다. 가격 판매로 새 토큰을 런칭하거나 맞춤형 토큰 배포 시스템을 구축할 때, Genesis는 이를 실현할 수 있는 온체인 인프라를 제공합니다.
...
| 메커니즘 | 설명 | 이점 |
|-----------|-------------|----------|
| **Priced Sale** | 고정 가격 토큰 판매 | 고정 가격은 복잡성과 투기를 줄입니다. 선착순 방식은 조기 참여를 장려합니다. 정확한 수요 예측으로 더 예측 가능한 결과를 얻습니다. 원하는 경우 캡과 지갑 게이트를 구현할 수 있습니다. |
