---
title: Genesis - 솔라나 토큰 출시 스마트 컨트랙트
metaTitle: Genesis | 솔라나 TGE 및 토큰 출시 플랫폼 | 공정한 출시 | Metaplex
description: Genesis 스마트 컨트랙트로 솔라나에서 토큰을 출시하세요. 토큰 생성 이벤트(TGE), 공정한 출시, ICO, 가격 책정 판매, Launch Pool을 온체인에서 구축하세요.
created: '01-15-2025'
updated: '01-31-2026'
keywords:
  - token launch
...
Genesis는 솔라나에서 토큰을 출시하기 위한 온체인 인프라를 제공합니다. 다음을 처리합니다:
...
Genesis를 출시자(여러분)와 참가자 사이에 위치하여 공정하고 투명하며 자동화된 토큰 배포를 보장하는 스마트 컨트랙트로 생각하세요.
...
| 메커니즘 | 가격 | 배포 | 최적 용도 |
|-----------|-------|--------------|----------|
| **[Launch Pool](/ko/smart-contracts/genesis/launch-pool)** | 마감 시 발견 | 예치금에 비례 | 공정한 출시, 커뮤니티 토큰 |
| **[Presale](/ko/smart-contracts/genesis/presale)** | 사전 고정 | 선착순 | 예측 가능한 모금, 알려진 밸류에이션 |
| **[Uniform Price Auction](/ko/smart-contracts/genesis/uniform-price-auction)** | 클리어링 가격 | 최고 입찰자 우선 | 대규모 모금, 기관 투자자 관심 |

### 어떤 것을 사용해야 하나요?

**Launch Pool** - 유기적인 가격 발견과 공정한 배포를 원할 때. 예치한 모든 사람이 자신의 지분에 비례하여 토큰을 받습니다. 누구도 선점당하지 않습니다.

**Presale** - 밸류에이션을 알고 있고 예측 가능한 가격 책정을 원할 때. 고정 가격을 설정하고 참가자들이 한도에 도달할 때까지 구매하도록 합니다.

**Auction** - 대규모 참가자들의 경쟁 입찰을 원할 때. 기관 투자자의 관심이 있는 기존 프로젝트에 가장 적합합니다.
