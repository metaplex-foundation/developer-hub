...
faqs:
  ...
  - q: Genesis를 사용하는 데 비용이 얼마나 드나요?
    a: Genesis는 본딩 커브 수수료 모델을 사용합니다. 프리본드 스왑에는 0.50% 프로토콜 수수료와 0.60% 크리에이터 수익이 있습니다. 포스트본드 거래에는 0.40% 프로토콜 수수료, 0.60% 크리에이터 수익, 0.17% LP 수수료, 0.08% Raydium 수수료가 있습니다. Launch Pool 예치 수수료는 무료(0%)이며 사용자 출금 수수료는 2%입니다.
  ...
  - q: 밈코인 출시 유형이란 무엇인가요?
    a: 밈코인 출시 유형은 하드코딩된 기본값을 사용하는 간소화된 옵션입니다 — 1시간 예치 기간, 고정 5억 토큰 할당 (10억 공급량의 50%), 98% Raydium LP, 1% 생성자 잠금 해제, 영구 LP 잠금. 예치 시작 시간만 설정하면 됩니다.
---
...
*이 수수료는 크리에이터가 유동성을 출금할 때만 적용됩니다.
...
Genesis는 본딩 커브 수수료 모델을 사용합니다. 프리본드 스왑에는 0.50% 프로토콜 수수료와 0.60% 크리에이터 수익이 있습니다. 포스트본드 거래에는 0.40% 프로토콜 수수료, 0.60% 크리에이터 수익, 0.17% LP 수수료, 0.08% Raydium 수수료가 있습니다. Launch Pool 예치 수수료는 무료(0%)이며 사용자 출금 수수료는 2%입니다.
