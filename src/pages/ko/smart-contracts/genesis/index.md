...
faqs:
  ...
  - q: Genesis를 사용하는 데 비용이 얼마나 드나요?
    a: Genesis는 예치금에 대해 0% 프로토콜 수수료를 부과합니다. 초기 비용은 없습니다 - 솔라나 트랜잭션 수수료와 모금된 자금에 대한 프로토콜 수수료만 지불하면 됩니다.
...
Genesis는 예치금에 대해 0% 프로토콜 수수료를 부과합니다. 초기 비용은 없습니다—솔라나 트랜잭션 수수료와 모금된 자금에 대한 프로토콜 수수료만 지불하면 됩니다.
