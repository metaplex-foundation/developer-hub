...
아직 컬렉션이 없다면 [`@metaplex-foundation/mpl-core` 라이브러리](/ko/smart-contracts/core/collections#creating-a-collection-with-plugins)를 사용하여 하나를 만들 수 있습니다. 컬렉션에 `BubblegumV2` 플러그인도 추가해야 한다는 점을 명심하세요.
