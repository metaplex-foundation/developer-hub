...
{% callout %}
따로 하는 대신 사용 가능한 [create helper](/ko/smart-contracts/token-metadata/mint#create-helpers) 함수를 사용하여 토큰을 생성하고 초기화하는 것이 권장됩니다. 이를 수행하는 방법을 찾고 있다면 대신 이 가이드를 확인하세요 [`Solana 토큰을 생성하는 방법`](/ko/guides/javascript/how-to-create-a-solana-token).
