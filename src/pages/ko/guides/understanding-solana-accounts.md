...
- [Solana CLI installed](/guides/solana-cli-essentials) (for examples)
...
See [Understanding PDAs](/guides/understanding-pdas) for more details.
...
- [Understanding PDAs](/guides/understanding-pdas) - Dive deeper into Program Derived Addresses
- [Transaction fundamentals](/guides/solana-transaction-fundamentals) - How transactions work on Solana
- [Create a Solana token](/guides/javascript/how-to-create-a-solana-token) - Put this knowledge into practice
