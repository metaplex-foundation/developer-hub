...
- [`getAssets`](/ko/dev-tools/das-api/methods/get-assets): 메타데이터 및 소유자를 포함한 여러 압축된/표준 자산의 정보를 반환합니다. 각 항목은 `getAsset`과 동일한 자산 형태를 사용하며, `MplCoreAsset` 행에만 에이전트 필드가 포함될 수 있습니다.
