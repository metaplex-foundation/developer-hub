...
- [`getAssetsByAuthority`](/das-api/methods/get-assets-by-authority): 권한 주소가 지정된 자산 목록을 반환합니다.
- [`getAssetsByCreator`](/das-api/methods/get-assets-by-creator): 생성자 주소가 지정된 자산 목록을 반환합니다.
- [`getAssetsByGroup`](/das-api/methods/get-assets-by-group): 그룹(키, 값) 쌍이 지정된 자산 목록을 반환합니다. 예를 들어 컬렉션의 모든 자산을 가져오는 데 사용할 수 있습니다.
- [`getAssetsByOwner`](/das-api/methods/get-assets-by-owner): 소유자 주소가 지정된 자산 목록을 반환합니다.
