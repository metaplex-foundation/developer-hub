...
- [Solana 및 SVM 데이터 읽기](/ko/dev-tools/aura/reading-solana-and-svm-data): Aura 네트워크는 [Metaplex Digital Asset Standard (DAS) API](/ko/dev-tools/das-api)를 사용하여 쿼리할 수 있는 자산 데이터의 데이터 가용성과 분산형 인덱싱을 제공합니다.