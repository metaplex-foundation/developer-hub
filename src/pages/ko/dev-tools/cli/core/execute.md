...
Asset Signer PDA와 에이전트의 Core 에셋은 서로 다른 두 주소입니다. 항상 Asset Signer PDA에 자금을 보내야 합니다.
{% /callout %}
...
- 에셋 계정 자체는 SOL을 보유할 수 없습니다. 렌트 면제 최소 금액을 초과하는 lamports는 Core 프로토콜 수수료로 취급되어 Metaplex 수수료 수집기에 의해 회수됩니다.
