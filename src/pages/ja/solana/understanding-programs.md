...
これは、プログラムが[Cross-Program Invocations](#cross-program-invocations-cpi)に署名することを可能にしたり、決定論的に派生できるアドレス内でアカウントの作成を可能にするなど、さまざまな用途があります。
