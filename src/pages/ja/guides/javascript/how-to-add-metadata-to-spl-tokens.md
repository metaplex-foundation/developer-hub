...
{% callout %}
代わりに利用可能な[createヘルパー](https://metaplex.com/docs/token-metadata/mint#create-helpers)関数を使用してトークンを作成・初期化することを推奨します。これを行う方法については、代わりにこのガイド[`Solanaトークンの作成方法`](https://metaplex.com/docs/guides/javascript/how-to-create-a-solana-token)をご確認ください。
