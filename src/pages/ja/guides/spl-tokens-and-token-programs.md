...
- [Create a Solana token](/guides/javascript/how-to-create-a-solana-token) - Hands-on token creation
- [Add metadata to tokens](/guides/javascript/how-to-add-metadata-to-spl-tokens) - Enrich tokens with Metaplex metadata
- [Metaplex Core overview](/core) - The modern NFT standard
- [Understanding Solana accounts](/guides/understanding-solana-accounts) - Deeper account model understanding
