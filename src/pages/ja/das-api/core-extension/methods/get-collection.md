---
title: Core Collection n÷ó
metaTitle: Collection n÷ó | DAS API Core ·5_˝
description: MPL Core Collection n≈1í‘Y
---

·ø«¸ø@	„êUå_◊È∞§Û«¸øí+ÄMPL Core Collection n≈1í‘W~Y

## ≥¸…ã

`<ENDPOINT>` í∫n RPC k`<PublicKey>` n$í÷óW_D MPL Core Collection nlãuknM€HfO`UD
