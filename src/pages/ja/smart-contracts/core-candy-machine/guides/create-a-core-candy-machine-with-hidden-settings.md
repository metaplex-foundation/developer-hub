...
// Solana Devnetをエンドポイントとして使用し、`mplCoreCandyMachine()`プラグインも読み込みます。
...
UMIのセットアップの詳細については、[こちら](https://metaplex.com/docs/core/guides/javascript/how-to-create-a-core-nft-asset-with-javascript#setting-up-umi)をご覧ください。
...
このプロセスはデフォルトでは決定論的ではない可能性があります。決定論的な方法で行うには、[turbo](https://metaplex.com/docs/guides/general/create-deterministic-metadata-with-turbo)を使用できます。
...
コレクションの詳細については、[こちら](https://metaplex.com/docs/core/collections)をご覧ください。
...
Core Candy Machineの作成とguardsの詳細については、[こちら](https://metaplex.com/docs/core-candy-machine/create)をご覧ください。

さらに、ミントがいつ始まるかを決定するstartDate guardを設定します。これは利用可能な多くのguardの1つに過ぎず、利用可能なすべてのguardのリストは[こちら](https://metaplex.com/docs/candy-machine/guards)で見つけることができます。
