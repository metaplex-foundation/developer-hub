...
faqs:
  ...
  - q: Core Assetのミントにはいくらかかりますか？
    a: ベースアセットあたり約0.003 SOLで、Token Metadataの約0.022 SOLと比較できます。これによりCoreはミントが約80%安くなります。
...
- シングルアカウント設計：ミントあたり約0.003 SOL（Token Metadataの0.022 SOLに対して）
...
|----------|-----------|---------------|
| **Metaplex Core** | 約0.003 SOL | 約17,000 CU |
...
**Groups**（`GroupV1`）は、コレクション、スタンドアロンアセット、ネストされたグループを整理できる別の分類レイヤーです。グループとコレクションの使い分けについては [Core Groups](/ja/smart-contracts/core/groups) を参照してください。
...
ベースアセットあたり約0.003 SOLで、Token Metadataの約0.022 SOLと比較できます。これによりCoreはミントが約80%安くなります。詳細については[Token Metadataとの違い](/ja/smart-contracts/core/tm-differences)をご覧ください。
