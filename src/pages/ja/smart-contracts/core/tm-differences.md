...
- **80%以上のコスト削減**: ミントあたり約0.003 SOL vs 0.022 SOL
...
## 違いの概要 {% #difference-overview %}
- **前例のないコスト効率**: Metaplex Coreは、利用可能な代替手段と比較して最も低いミントコストを提供します。例えば、Token Metadataで0.022 SOLかかるNFTは、Coreで約0.003 SOLでミントできます。
...
### ライフサイクルイベントとプラグイン {% #lifecycle-events-and-plugins %}
