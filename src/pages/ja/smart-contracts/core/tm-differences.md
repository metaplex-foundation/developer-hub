...
- **80%以上のコスト削減**: ミントあたり約0.003 SOL（0.0015 SOLのプロトコル手数料を含む） vs 0.022 SOL
...
| ミントコスト | 約0.022 SOL | 約0.003 SOL（0.0015 SOLのプロトコル手数料を含む） |
...
## 違いの概要
- **前例のないコスト効率**: Metaplex Coreは、利用可能な代替手段と比較して最も低いミントコストを提供します。例えば、Token Metadataで0.022 SOLかかるNFTは、Coreで約0.003 SOL（0.0015 SOLのプロトコル手数料を含む）でミントできます。
