...
Metaplexがホストする以下のURL構造のゲートウェイを使用できます：`https://igw.metaplex.com/<network>/<account>`（例：[View Example on Inscription Gateway](https://igw.metaplex.com/devnet/Fgf4Wn3wjVcLWp5XnMQ4t4Gpaaq2iRbc2cmtXjrQd5hF)）、またはカスタムURLでゲートウェイを自分でホストすることができます。
