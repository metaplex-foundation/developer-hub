...
次に、どのウォレットを使用するかをUmiに伝えます。これは[キーペア](/ja/dev-tools/umi/connecting-to-umi#connecting-w-a-secret-key)または[solana wallet adapter](/ja/dev-tools/umi/connecting-to-umi#connecting-w-wallet-adapter)のいずれかにできます。
