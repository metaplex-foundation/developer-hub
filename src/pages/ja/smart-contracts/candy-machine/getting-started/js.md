...
次に、使用するウォレットをUmiに伝える必要があります。これは[キーペア](/ja/dev-tools/umi/getting-started#connecting-w-a-secret-key)または[Solanaウォレットアダプター](/ja/dev-tools/umi/getting-started#connecting-w-wallet-adapter)のいずれかです。
