...
description: "Token Paymentガードは、支払者にトークンを請求することでミントを許可します。"
---
...
{% dialect-switcher title="Token Paymentガードでミントする" %}
{% dialect title="JavaScript" id="js" %}
{% totem %}
...
APIリファレンス: [mintV2](https://mpl-candy-machine.typedoc.metaplex.com/functions/mintV2.html), [TokenPaymentMintArgs](https://mpl-candy-machine.typedoc.metaplex.com/types/TokenPaymentMintArgs.html)
