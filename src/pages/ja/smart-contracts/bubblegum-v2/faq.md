...
- **ロイヤリティ強制**: Bubblegum V2は[MPL-Core](https://docs.metaplex.com/ja/smart-contracts/core/overview)コレクションを使用しているため、`ProgramDenyList`などを使用してcNFTにロイヤリティを強制することが可能です。
