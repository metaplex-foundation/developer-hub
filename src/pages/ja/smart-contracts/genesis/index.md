...
faqs:
  ...
  - q: Genesis の利用にかかる費用はいくらですか？
    a: Genesis はボンディングカーブ手数料モデルを使用しています。プレボンドスワップには 0.50% のプロトコル手数料と 0.60% のクリエイター収益があります。ポストボンド取引には 0.40% のプロトコル手数料、0.60% のクリエイター収益、0.17% の LP 手数料、0.08% の Raydium 手数料があります。Launch Pool の預入手数料は無料（0%）で、ユーザー引出手数料は 2% です。
...
*この手数料はクリエイターが流動性を引き出す場合にのみ適用されます。
...
Genesis はボンディングカーブ手数料モデルを使用しています。プレボンドスワップには 0.50% のプロトコル手数料と 0.60% のクリエイター収益があります。ポストボンド取引には 0.40% のプロトコル手数料、0.60% のクリエイター収益、0.17% の LP 手数料、0.08% の Raydium 手数料があります。Launch Pool の預入手数料は無料（0%）で、ユーザー引出手数料は 2% です。
