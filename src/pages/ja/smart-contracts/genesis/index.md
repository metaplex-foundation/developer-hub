...
faqs:
  ...
  - q: Genesis の利用にかかる費用はいくらですか？
    a: Genesis は、ボンディングカーブでのスワップとグラデュエーション後の Raydium CPMM 取引にプロトコル手数料を課し、クリエイターが Launch Pool または Presale の調達資金を引き出す際にも手数料を課します。Launch Pool と Presale の CPMM 手数料は、ローンチでクリエイター報酬を有効にしているかどうかによっても変わります。現在の内訳についてはプロトコル手数料セクションをご覧ください。
...
Genesis の手数料は、ローンチタイプと、ローンチが Raydium CPMMプールへグラデュエーションしたかどうかによって異なります。Launch Pool と Presale の CPMM 手数料は、ローンチでクリエイター報酬を有効にしているかどうかによっても変わります。ボンディングカーブの CPMMプールには、クリエイター報酬が常に含まれます。
...
Genesis は、ボンディングカーブでのスワップとグラデュエーション後の Raydium CPMM 取引にプロトコル手数料を課し、クリエイターが Launch Pool または Presale の調達資金を引き出す際にも手数料を課します。Launch Pool と Presale の CPMM 手数料は、ローンチでクリエイター報酬を有効にしているかどうかによっても変わります。現在の内訳については[プロトコル手数料](#プロトコル手数料)をご覧ください。
