...
faqs:
  ...
  - q: Genesis の利用にかかる費用はいくらですか？
    a: Genesis は、ボンディングカーブでのスワップとグラデュエーション後の Raydium CPMM 取引にプロトコル手数料を課し、クリエイターが Launch Pool または Presale の調達資金を引き出す際にも手数料を課します。Launch Pool と Presale の CPMM 手数料は、ローンチでクリエイター手数料を有効にしているかどうかによっても変わります。現在の内訳についてはプロトコル手数料セクションをご覧ください。
  ...
  - q: Genesis はどのようなローンチタイプに対応していますか？
    a: Genesis は複数のローンチタイプに対応しています。Launch Pool（比例配分と価格発見を伴うフェアローンチ）と Presale（固定価格トークンセール）です。
---
...
- **ノーコードでローンチしたい方は？** [Metaplex トークンローンチパッド](https://www.metaplex.com)を使えば、コード不要でトークンをローンチできます
...
すべてのGenesisローンチには、それを分類する**タイプ**があります：
...
Genesis の手数料は、ローンチタイプと、ローンチが Raydium CPMMプールへグラデュエーションしたかどうかによって異なります。Launch Pool と Presale の CPMM 手数料は、ローンチでクリエイター手数料を有効にしているかどうかによっても変わります。ボンディングカーブの CPMMプールでは、クリエイター手数料が常に発生します。
...
Genesis は、ボンディングカーブでのスワップとグラデュエーション後の Raydium CPMM 取引にプロトコル手数料を課し、クリエイターが Launch Pool または Presale の調達資金を引き出す際にも手数料を課します。Launch Pool と Presale の CPMM 手数料は、ローンチでクリエイター手数料を有効にしているかどうかによっても変わります。現在の内訳については[プロトコル手数料](#プロトコル手数料)をご覧ください。

### ローンチ後にトークン権限を取り消すことはできますか？
はい。Genesis は `revokeV2` 命令を提供しており、ミントおよびフリーズ権限を恒久的に取り消すことができます。
...
| **ローンチタイプ** | ローンチの基盤メカニズム：`launchpool` または `presale`。作成後にバックエンドクランクによってオンチェーンで設定 |
