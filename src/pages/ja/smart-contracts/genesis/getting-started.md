...
| **ローンチタイプ** | ローンチの基盤メカニズム：`launchpool` または `presale`。作成後にバックエンドクランクによってオンチェーンで遡及的に設定。[SDK](/smart-contracts/genesis/sdk/javascript#genesis-account)または[REST API](/smart-contracts/genesis/integration-apis)で照会可能 |
