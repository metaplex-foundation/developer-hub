...
faqs:
  ...
  - q: ユーザーは入金を引き出せますか？
    a: はい、入金期間中に引き出すことができます。システムの悪用を防ぐため、0% の引き出し手数料が適用されます。
  - q: 複数回入金するとどうなりますか？
...
- ユーザーは入金ウィンドウ期間中に SOL を入金します（0% の手数料が適用）
- 入金期間中は引き出しが可能です（0% の手数料）
- トークン配布は入金シェアに比例します
...
ユーザーは入金期間中に引き出すことができます。0% の手数料が適用されます。
...
### ユーザーは入金を引き出せますか？
はい、入金期間中に引き出すことができます。システムの悪用を防ぐため、0% の引き出し手数料が適用されます。
