...
すべてのプロトコル手数料は、Metaplexエコシステムの研究、開発、採用を促進するために設立された非営利団体であるMetaplex Foundationの目的を推進するために使用されます。現在、プロトコル手数料の50%が$MPLXに変換され、Metaplex DAOトレジャリーに拠出されます。残りの50%はMetaplex Foundationの運営のために確保されます。
