...
以下代码是一个完整可运行的示例。可自定义的参数如下所示。有关NFT创建的更多详情，请参阅[Core文档](/zh/smart-contracts/core)。
...
以下是上传所需的最少元数据。`external_url`、`attributes`、`properties`等附加字段是可选的，详细描述和示例可在[JSON模式](/zh/smart-contracts/core/json-schema)中找到。您需要将JSON和图像上传到可公开访问的位置。我们建议使用Web3存储提供商，如Arweave。如果您想在代码中完成此操作，请按照此[指南](/zh/guides/general/create-deterministic-metadata-with-turbo)操作。
