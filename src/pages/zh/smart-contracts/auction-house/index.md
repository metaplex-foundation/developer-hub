...
该账户可以按用户想要的任何方式配置。我们将[在专门的页面中详细讨论这些配置](/zh/smart-contracts/auction-house/settings),但这里有一些有趣的可配置参数:
...
- [入门](/zh/smart-contracts/auction-house/getting-started)

我们将继续深入探讨拍卖行设置以及如何管理拍卖行实例:

- [拍卖行设置](/zh/smart-contracts/auction-house/settings)
- [管理拍卖行](/zh/smart-contracts/auction-house/manage)

一旦我们了解了拍卖行的基础知识,我们就可以开始学习如何在拍卖行支持的市场上交易资产:

- [在拍卖行上交易资产](/zh/smart-contracts/auction-house/trading-assets)
- [管理买方账户](/zh/smart-contracts/auction-house/buyer-escrow)

我们还将探讨如何跟踪拍卖行上的列表、出价和销售以及如何获取它们:

- [打印收据](/zh/smart-contracts/auction-house/receipts)
- [查找出价、列表和购买](/zh/smart-contracts/auction-house/find)
