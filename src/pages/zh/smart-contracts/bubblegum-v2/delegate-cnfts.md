...
- [转移cNFT](/zh/bubblegum-v2/transfer-cnfts)：转移后委托权限将被重置——即设置为新所有者。
...
此外，由于此指令替换Bubblegum树上的叶子，因此必须提供更多参数来验证压缩NFT的完整性，由于这些参数对于所有改变叶子的指令都是通用的，它们在[以下FAQ](/zh/bubblegum-v2/faq#replace-leaf-instruction-arguments)中有记录。幸运的是，我们可以使用辅助方法，该方法将使用Metaplex DAS API自动为我们获取这些参数。
