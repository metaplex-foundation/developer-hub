...
请注意，由于此指令替换Bubblegum树上的叶子，必须提供额外的参数来验证压缩NFT的完整性才能销毁它。由于这些参数对于所有改变叶子的指令都是通用的，它们在[以下FAQ](/zh/bubblegum-v2/faq#replace-leaf-instruction-arguments)中有记录。幸运的是，我们可以使用辅助方法，该方法将使用Metaplex DAS API自动为我们获取这些参数。
