...
如果您还没有集合，可以使用[`@metaplex-foundation/mpl-core`库](https://metaplex.com/docs/core/collections#creating-a-collection-with-plugins)创建一个。请记住，您还需要将`BubblegumV2`插件添加到集合中。
