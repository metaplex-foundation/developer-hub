...
faqs:
  ...
  - q: cNFT可以从MPL-Core集合继承版税吗？
    a: 可以。铸造到具有Royalties插件的集合时，可省略sellerFeeBasisPoints（或传入SELLER_FEE_BASIS_POINTS_INHERIT哨兵）。叶子上存储65535（0xffff）；DAS将集合费率放在royalty.basis_points上，哨兵放在royalty.basis_points_raw上。
---
...
## 从集合继承版税 {% #inheriting-royalties-from-the-collection %}
