...
- 对于从集合继承卖家费用的 Bubblegum V2 cNFT，DAS 在 `royalty.basis_points` 上保留叶子哨兵，并在 `*_inherited` 字段上暴露集合费率。请参阅[读取继承版税](/zh/smart-contracts/bubblegum-v2/reading-inherited-royalties)。
