...
faqs:
  ...
  - q: 使用 Genesis 需要多少费用？
    a: Genesis 使用联合曲线费用模型。预毕业交换有 0.50% 协议费和 0.60% 创作者收入。毕业后交易有 0.40% 协议费、0.60% 创作者收入、0.17% LP 费用和 0.08% Raydium 费用。Launch Pool 存款免费（0%），用户提款费为 2%。
  - q: 发行后可以撤销代币权限吗？
...
### 使用 Genesis 需要多少费用？
Genesis 使用联合曲线费用模型。预毕业交换有 0.50% 协议费和 0.60% 创作者收入。毕业后交易有 0.40% 协议费、0.60% 创作者收入、0.17% LP 费用和 0.08% Raydium 费用。Launch Pool 存款免费（0%），用户提款费为 2%。
