...
metaTitle: Genesis - Uniform Price Auction | 代币拍卖 | Metaplex
description: 基于时间的代币发行拍卖机制，采用统一清算价格。适合大型参与者的竞争性出价。
created: '01-15-2025'
updated: '01-31-2026'
keywords:
...
**Uniform Price Auction** 为代币发行提供竞争性出价机制。所有中标者支付相同的清算价格——即最低的中标出价——确保结构化代币分配中公平的价格发现。 {% .lead %}
...
- [Launch Pool](/zh/smart-contracts/genesis/launch-pool) - 按比例分配与价格发现
- [Presale](/zh/smart-contracts/genesis/presale) - 固定价格代币销售
- [Genesis 概览](/zh/smart-contracts/genesis) - 核心概念与架构
