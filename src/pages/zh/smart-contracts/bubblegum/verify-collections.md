...
如果您不熟悉NFT相关的集合概念，它们是特殊的非压缩NFT，可用于将其他NFT分组在一起。因此，**集合NFT**的数据用于描述整个集合的名称和品牌。您可以[在此处阅读更多关于Metaplex已验证集合的信息](/zh/smart-contracts/token-metadata/collections)。

请注意，可以使用[此处记录的](/zh/smart-contracts/bubblegum/mint-cnfts#minting-to-a-collection)**Mint to Collection V1**指令直接将压缩NFT铸造到集合中。也就是说，如果您已经铸造了一个没有集合的cNFT，让我们看看如何验证、取消验证以及设置该cNFT上的集合。
