...
**Token2022 支付** 守卫通过从配置的铸币账户向付款人收取一些代币来允许铸造。代币数量和目标地址也可以配置。
...
{% /node %}
{% node theme="dimmed" %}
所有者: Token 2022 程序 {% .whitespace-nowrap %}
{% /node %}
{% /node %}
...
**Token2022 支付** 守卫的工作方式与 **代币支付** 守卫相同——唯一的区别是铸币和代币账户应该来自 [SPL Token-2022 程序](https://spl.solana.com/token-2022)。
...
请注意，如果您计划在没有我们 SDK 帮助的情况下构建指令，您需要将这些铸造设置和更多内容作为指令参数和剩余账户的组合提供。有关更多详细信息，请参阅 [Candy Guard 程序文档](https://github.com/metaplex-foundation/mpl-core-candy-machine/tree/main/programs/candy-guard#tokenpayment)。
...
API 参考：[mintV1](https://mpl-core-candy-machine.typedoc.metaplex.com/functions/mintV1.html), [TokenPaymentMintArgs](https://mpl-core-candy-machine.typedoc.metaplex.com/types/Token2022PaymentMintArgs.html)
