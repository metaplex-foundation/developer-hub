...
description: 开始使用 Metaplex 的 Core Candy Machine 程序的 mpl-core-candy-machine Rust SDK。
---

## Core Candy Machine

Core Candy Machine 是 Candymachine 的核心,允许初始化和填充 Core Candy Machine

### 安装

MPL-Core Rust SDK 可用于脚本/桌面/移动应用程序以及 Solana 链上程序。
...
Core Candy Guards crate 允许创建和管理可以包装在 Core Candy Machine 上的 Core Candy Guard。
