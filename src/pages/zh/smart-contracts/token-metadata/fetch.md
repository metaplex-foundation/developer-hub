...
{% dialect-switcher title="按铸造获取资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按元数据获取资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按铸造列表获取资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按创作者获取资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按更新权限获取资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按铸造获取带代币的资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按所有者获取带代币的资产" %}
{% dialect title="JavaScript" id="js" %}
...
{% dialect-switcher title="按铸造和所有者获取带代币的资产" %}
{% dialect title="JavaScript" id="js" %}
