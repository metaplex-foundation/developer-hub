...
| 铸造成本 | ~0.022 SOL | ~0.003 SOL（含 0.0015 SOL 协议费用） |
...
3. 收藏级操作是原生的
## 区别概述
- **前所未有的成本效率**: Metaplex Core 提供与可用替代方案相比最低的铸造成本。例如，使用 Token Metadata 需要 0.022 SOL 的 NFT 可以用 Core 以约 0.003 SOL（含 0.0015 SOL 协议费用）铸造。
