---
title: End Date 守卫
metaTitle: Candy Machine Guards - End Date 守卫 | Candy Machine
description: "确定铸造的结束日期。"
---

## 概述

**End Date** 守卫指定铸造的结束日期。在此日期之后，不再允许铸造。
...
API 参考：[create](https://mpl-candy-machine.typedoc.metaplex.com/functions/create.html)、[EndDate](https://mpl-candy-machine.typedoc.metaplex.com/types/EndDate.html)
