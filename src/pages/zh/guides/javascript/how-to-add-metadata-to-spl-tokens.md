...
{% callout %}
建议使用可用的 [create helper](https://metaplex.com/docs/token-metadata/mint#create-helpers) 函数来创建和初始化您的代币，而不是单独执行此操作。如果您想了解如何执行此操作，请改为查看本指南 [`如何创建 Solana 代币`](https://metaplex.com/docs/guides/javascript/how-to-create-a-solana-token)。
