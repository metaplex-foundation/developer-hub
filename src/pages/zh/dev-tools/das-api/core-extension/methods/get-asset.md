---
title: 获取 Core 资产
metaTitle: 获取资产 | DAS API Core 扩展
description: 返回 MPL Core 资产的信息
---

返回 MPL Core 资产的信息，例如包括元数据、所有者和解析的插件数据，以及从集合继承的数据。

## 代码示例

将 `<ENDPOINT>` 替换为您的个人 RPC，将 `<PublicKey>` 值替换为您要获取的 NFT 的公钥。
