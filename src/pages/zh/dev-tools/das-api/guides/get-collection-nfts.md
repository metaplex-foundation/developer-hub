...
您也可以使用带有集合分组的 `searchAssets` 进行更具体的查询。有关更多信息，请参阅[按条件搜索资产](/zh/das-api/guides/search-by-criteria)。
...
1. **使用[分页](/zh/das-api/guides/pagination)** 处理大型集合以避免速率限制
2. **在可能时缓存结果** 以提高性能
3. **包含[显示选项](/zh/das-api/guides/display-options)** 以获取额外的元数据
...
- [获取钱包中的所有代币](/zh/das-api/guides/get-wallet-tokens) - 查看钱包拥有的所有内容
