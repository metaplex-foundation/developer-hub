...
- 所有六个程序（Agent Registry、Genesis、Core、Token Metadata、Bubblegum、Candy Machine）都支持 CLI 和 Umi SDK
...
| Kit SDK（仅 TM） | [`@metaplex-foundation/mpl-token-metadata-kit`](https://github.com/metaplex-foundation/mpl-token-metadata) |
