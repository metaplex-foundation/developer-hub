...
Instead of passing the Merkle Proof directly to the mint instruction, the minting wallet must perform a [Pre-Validation](/programs/core-candy-machine/mintg#minting-with-pre-validation) by using the route instruction of the Allow List guard.
