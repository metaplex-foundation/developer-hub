...
- The `mechanic` field indicates the allocation mechanism (e.g., `launchpoolV2`, `presaleV2`, `bondingCurveV2`). The `type` field indicates the underlying launch mechanism (`launchpool`, `presale`, or `bondingCurve`).
