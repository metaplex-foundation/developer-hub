---
title: Fund Agent
metaTitle: Agents - Fund Agent Wallet | REST API | Metaplex
...
The sender deserializes, signs, and submits the transaction — see [Signing and Submitting](/agents/api/mint-agent#signing-and-submitting).
...
- To move funds back out, the agent owner uses [Withdraw](/agents/api/withdraw-agent).
