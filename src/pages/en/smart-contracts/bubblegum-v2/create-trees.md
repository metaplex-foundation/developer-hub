...
Below is an interactive calculator to help you estimate tree creation costs. Enter the number of cNFTs you need, or use the advanced mode to fine-tune all tree parameters and see how they affect cost, proof size, and tree structure.
...
- **Public**: Whether or not the Bubblegum Tree should be public. If it is public, anyone will be able to mint Compressed NFTs from it. Otherwise, only the Tree Creator or the Tree Delegate (as discussed in [Delegating cNFTs](/smart-contracts/bubblegum-v2/delegate-cnfts)) will be able to mint Compressed NFTs.
