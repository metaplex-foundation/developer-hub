...
3. **Find by trade state**: We talked about [Trade States in the overview page](/smart-contracts/auction-house). Trade state PDA accounts encoding the bid / listing / sale orders can also be used to find the corresponding action.
