...
## Conclusion
Now that we know about Auction House settings, on the [next page](/smart-contracts/auction-house/manage), we’ll see how we can use them to create and update our own Auction House.
