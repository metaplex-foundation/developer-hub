...
{% callout type="note" %}
For new projects, we recommend using [Metaplex Core](/smart-contracts/core) for soulbound NFTs as it provides a simpler and more efficient approach. See the [Create a Soulbound NFT Asset guide](/smart-contracts/core/guides/create-soulbound-nft-asset) for details.
{% /callout %}
...
{% totem %}
{% totem-accordion title="Show code example" %}
...
- [BurnNft](https://github.com/metaplex-foundation/mpl-token-metadata/blob/d1a13273cb23c033bda97b4d47b9731b51ef5a2f/programs/token-metadata/program/src/instruction/mod.rs#L383) has been replaced by [Burn](https://metaplex.com/docs/token-metadata/burn).
- [BurnEditionNft](https://github.com/metaplex-foundation/mpl-token-metadata/blob/d1a13273cb23c033bda97b4d47b9731b51ef5a2f/programs/token-metadata/program/src/instruction/mod.rs#L487) has been replaced by [Burn](https://metaplex.com/docs/token-metadata/burn).
