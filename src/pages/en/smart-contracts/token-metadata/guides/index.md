...
{% quick-link title="Get Mints by Collection" icon="CodeBracketSquare" href="/smart-contracts/token-metadata/guides/get-by-collection" description="Snippets to fetch NFTs by Collection" /%}

{% quick-link title="Create an NFT" icon="CodeBracketSquare" href="/smart-contracts/token-metadata/guides/javascript/create-an-nft" description="Create your very own NFT using Javascript" /%}
