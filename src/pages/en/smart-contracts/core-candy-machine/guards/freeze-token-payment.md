...
When using multiple Freeze Token Payment guards within various [Guard Groups](/smart-contracts/core-candy-machine/guard-groups), it is important to understand the relationship between a Freeze Token Payment guard and a Freeze Escrow account.
