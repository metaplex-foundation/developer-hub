...
- An already created Candy Machine. Find more info on how to create one in [the Core Candy Machine creation guide](https://developers.metaplex.com/core-candy-machine/create).
