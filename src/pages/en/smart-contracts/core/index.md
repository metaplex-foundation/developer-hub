...
faqs:
  ...
  - q: How much does it cost to mint a Core Asset?
    a: Approximately 0.003 SOL per base asset, including the 0.0015 SOL Core protocol fee, compared to ~0.022 SOL for Token Metadata. This makes Core ~80% cheaper for minting.
...
- Single-account design: ~0.003 SOL per mint including the 0.0015 SOL protocol fee (vs 0.022 SOL for Token Metadata)
...
|----------|-----------|---------------|
| **Metaplex Core** | ~0.003 SOL (incl. 0.0015 SOL protocol fee) | ~17,000 CU |
...
Approximately 0.003 SOL per base asset, including the 0.0015 SOL Core protocol fee, compared to ~0.022 SOL for Token Metadata. This makes Core ~80% cheaper for minting. See [Differences from Token Metadata](/smart-contracts/core/tm-differences) for more details.
