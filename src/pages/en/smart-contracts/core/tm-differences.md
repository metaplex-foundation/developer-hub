...
| Mint cost | ~0.022 SOL | ~0.003 SOL (incl. 0.0015 SOL protocol fee) |
...
## Difference Overview
- **Unprecedented Cost Efficiency**: Metaplex Core offers the lowest minting costs compared to available alternatives. For instance, an NFT that would cost .022 SOL with Token Metadata can be minted with Core for ~0.003 SOL (including the 0.0015 SOL protocol fee).
