...
If you're not familiar with the new Appdata Plugin, read more about it in [the AppData Plugin documentation](/smart-contracts/core/external-plugins/app-data).
