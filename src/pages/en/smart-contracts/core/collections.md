...
The following snippet creates a collection with the [Royalties Plugin](/smart-contracts/core/plugins/royalties) attached. You can attach additional plugins as described in [the Plugins documentation](/smart-contracts/core/plugins).
