...
You can either use the gateway that is hosted by Metaplex using the following URL structure: `https://igw.metaplex.com/<network>/<account>` or host the gateway yourself with a custom URL.
