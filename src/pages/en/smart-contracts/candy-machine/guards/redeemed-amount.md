...
This guard becomes more interesting when used with [Guard Groups](/smart-contracts/candy-machine/guard-groups) since it allows us to add global minting thresholds to our groups.
...
Thus, this guard becomes more useful when using [Guard Groups](/smart-contracts/candy-machine/guard-groups). Here’s another example using two groups such that the first 300 NFTs can be minted for 1 SOL but the last 200 will need 2 SOL to mint.
