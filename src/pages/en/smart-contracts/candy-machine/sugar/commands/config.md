...
You can either create this file manually, following these [instructions](/smart-contracts/candy-machine/sugar/configuration), or use the config create command:
