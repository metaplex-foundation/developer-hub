...
Metaplex programs have been generated via Kinobi to work and run as plugin's via Umi. Each program in the Metaplex library has a different use and purpose in the Solana eco system. You can find even more Plugins to use with Umi in the [interface implementations page](/dev-tools/umi/implementations)!

## [Bubblegum (cNFT)](/smart-contracts/bubblegum)
...
## [Candy Machine](/smart-contracts/candy-machine)
...
## [Inscriptions](/smart-contracts/inscription)
...
## [Token Metadata (NFT, pNFT)](/smart-contracts/token-metadata)
