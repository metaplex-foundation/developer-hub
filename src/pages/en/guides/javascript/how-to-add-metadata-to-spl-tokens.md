...
{% callout %}
It is recommended to use the available [create helper](https://metaplex.com/docs/token-metadata/mint#create-helpers) functions to create and initialize your token instead of doing so separately. If you are looking on how to do this, check out this guide instead [`How to create a Solana Token`](https://metaplex.com/docs/guides/javascript/how-to-create-a-solana-token).
